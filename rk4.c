...
#define POPULATION 13		//number of neurons in the whole population, should be 20 for accurate representation of mccarthy
#define MYCLUSTER 6			//number of neurons in the simulated neuron's population, should be 10 for accurate representation of mccarthy
