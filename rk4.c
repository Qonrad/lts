...
#define OFFSET 45			//number of spikes that are skipped to allow the simulation to "cool down" before it starts measuring the period
...
int main() {
	...
	if (PLONG) {
		...
		makefull(y, xx, nstep, "highdel0.data");
	}
	else {
